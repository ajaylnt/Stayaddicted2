<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test.aspx.cs" Inherits="MyApp.test1" %>
...
<body>
    ...
    <div id="about" class="auto-style16">
        <div class="container">
                ...
                <div class="col-lg-4 ">
                    <div class="div-img-bg">
                        <div class="auto-style15">
                            <img src="Images/me.jpg" class="auto-style7" alt="me">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portfolio-container">
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-thumbnail all branding uikits webdesign">
                            <a class="popup-img" href="images/portfolio/1.jpg">
                                <img src="Images/portfolio/1.jpg" alt="img" class="auto-style6">
                            </a>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-thumbnail all mockups uikits photography">
                            <a class="popup-img" href="images/portfolio/2.jpg">
                                <img src="Images/portfolio/2.jpg" alt="img" class="auto-style6">
                            </a>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-thumbnail all branding webdesig photographyn">
                            <a class="popup-img" href="images/portfolio/3.jpg">
                                <img src="Images/portfolio/3.jpg" alt="img" class="auto-style5">
                            </a>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-thumbnail all branding uikits photography">
                            <a class="popup-img" href="images/portfolio/5.jpg">
                                <img src="Images/portfolio/5.jpg" alt="img" class="auto-style14">
                            </a>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-thumbnail all mockups uikits webdesign">
                            <a class="popup-img" href="images/portfolio/6.jpg">
                                <img src="Images/portfolio/6.jpg" alt="img" class="auto-style8">
                            </a>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="journal-info">
                            ...
                            <a href="blog-single.html">
                                <img src="Images/blog-post-1.jpg" class="auto-style4" alt="img"></a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="journal-info">
                            ...
                            <a href="blog-single.html">
                                <img src="Images/blog-post-2.jpg" class="auto-style3" alt="img"></a>

                            <div class="journal-txt" style="left: 660px; top: 0px; width: 1136px">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="journal-info">
                            ...
                            <a href="blog-single.html">
                                <img src="Images/blog-post-3.jpg" class="auto-style2" alt="img"></a>
    ...
    <div id="contact" class="auto-style9">
        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group contact-block1">
                                        <input type="text" name="name" class="auto-style13" id="name" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input type="text" class="auto-style12" name="subject" id="subject" placeholder="Subject" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
                                        <div class="validation"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <textarea class="auto-style10" name="message" data-rule="required" data-msg="Please write something for us" placeholder="Message"></textarea>
                                        <div class="validation"></div>
                                    </div>
                                </div>
    ...
    <div id="footer" class="text-center">
        <div class="auto-style1">
            ...
            <div class="credits">
             Designed by <a href="https://bootstrapmade.com/">Stayaddicted2.com</a>
            </div>
    ...
    <script src="vendor/bootstrap/js/typed.js"></script>
    <script src="vendor/bootstrap/js/owl.carousel.min.js"></script>
    <script src="vendor/bootstrap/js/magnific-popup.min.js"></script>
    <script src="vendor/bootstrap/js/isotope.pkgd.min.js"></script>
